...
<div class="motopress-wrapper content-holder clearfix" style="padding-bottom: 30px; background: #FFF;">
	<div class="fluid-container">
		<div class="row">
			<div data-motopress-type="static" data-motopress-static-file="static/static-resources-image.php">
				<?php get_template_part("static/static-resources-image"); ?>
			</div>
		</div>
	</div>
