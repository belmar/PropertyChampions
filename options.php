...
// Fonts
			...
			$typography_mixed_fonts['Museo Sans'] = 'Museo Sans';			
...
// ---------------------------------------------------------
			...
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '50px', 'lineheight' => '35px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#004c92'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '35px', 'lineheight' => '26px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#004c92'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '25px', 'lineheight' => '22px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#373736'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '23px', 'lineheight' => '20px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#373736'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '18px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#373736'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '18px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#373736'));
...
// ---------------------------------------------------------
			...
			$options['logo_url'] = array(
								"id" => "logo_url",
								"std" => CHILD_URL . "/images/property-champions-default/property-champions-logo.png");
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '14px', 'lineheight' => '30px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#373736'));
...
// ---------------------------------------------------------
			...
			$options['footer_text'] = array(
								"id" => "footer_text",
								"std" => "Copyright @ 2014 Property Champions, LLC. All Rights Reserved. Designed by Spurpress");
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '14px', 'lineheight' => '30px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#808284'));
					//Social Links
			$options[] = array( 
								"name" => "Social",
								"type" => "heading"
			...
			$options['facebook_icon'] = array( 
								...
								"desc" => "Facebook Icon",
								"id" => "facebook_icon",
								"std" => get_stylesheet_directory_uri() . "/images/social/facebook.jpg",
								"type" => "upload"
			);
			...
			$options['twitter_icon'] = array( 
								...
								"desc" => "Twitter Icon",
								"id" => "twitter_icon",
								"std" => get_stylesheet_directory_uri() . "/images/social/twitter.jpg",
								"type" => "upload");
			...
			$options['linkedin_icon'] = array( 
								...
								"desc" => "LinkedIn Icon",
								"id" => "linkedin_icon",
								"std" => get_stylesheet_directory_uri() . "/images/social/linkedin.jpg",
								"type" => "upload");
			...
			$options['pinterest_icon'] = array( 
								...
								"desc" => "Pinterest Icon",
								"id" => "pinterest_icon",
								"std" => get_stylesheet_directory_uri() . "/images/social/pinterest.jpg",
								"type" => "upload");
			...
			$options['youtube_icon'] = array( 
								...
								"desc" => "Youtube Icon",
								"id" => "youtube_icon",
								"std" => get_stylesheet_directory_uri() . "/images/social/youtube.jpg",
								"type" => "upload");		
			return $options;
	}
}
