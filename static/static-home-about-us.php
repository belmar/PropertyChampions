	<div class="fluid-container">
		<div class="row">
			<div id="about-banner" class="property-champion-home-bg" style="margin-bottom:0">
				<div class="container">
					<div class="row">
						<div class="about-top-form span4">
							<h4 style="margin-bottom: 10px;font-size: 28px;line-height: 34px;">Are You a Savvy<br>Property Investor?</h4>
							<p>Gain Exclusive Access to the Best Returning Properties in the world, up to 24% Cash-flow per year by completing these Three Boxes:</p>
							<form method="get">
