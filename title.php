<section class="title-section <?php echo (get_post_type(get_the_ID()) == 'directory_listing') ?  'display-none' : '' ; ?>">	<h1 class="title-header">		
		<?php			get_post_type(get_the_ID());			$shop_page = false;
